        ...
        <section className="relative overflow-hidden">
          <div className="mx-auto max-w-6xl px-4 pt-16 pb-14 sm:pt-20 sm:pb-18">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/demo/offerlock"
                onClick={() => click("hero_primary_offerlock")}
                className={`${colors.goldBg} inline-flex h-11 items-center justify-center rounded-md px-5 font-medium`}
              >
                Try the OfferLock demo <ArrowRight className="ml-2 size-4" />
              </Link>
              <Link
                to="/personas"
                onClick={() => click("hero_secondary_personas")}
                className="inline-flex h-11 items-center justify-center rounded-md px-5 font-medium bg-white/10 hover:bg-white/15 focus:outline-none focus:ring-2 focus:ring-white/30"
              >
                Explore personas
              </Link>
            </div>
        ...
        <section className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {[
              ...
              <Link key={label} to={href} className="group rounded-xl border border-white/10 bg-white/5 p-4 hover:border-white/20 focus:outline-none focus:ring-2 focus:ring-white/30">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-16 sm:pb-20">
          ...
          <div className="mt-6 space-y-3">
            <details className="rounded-lg border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">What is OfferLock?</summary>
              <p className="mt-2 text-white/80">
                It’s a quick way to write down what was discussed so everyone’s aligned before you sign.
                It prevents “ghost edits” and saves time.
              </p>
            </details>
            <details className="rounded-lg border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">What’s a ‘receipt’ in this context?</summary>
              <p className="mt-2 text-white/80">
                A private, content-light proof of what happened and why (no oversharing). Useful for
                compliance, audits, and resolving disputes.
              </p>
            </details>
            <details className="rounded-lg border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">Can my school or parent see my deals?</summary>
              <p className="mt-2 text-white/80">
                Yes—if you share. They see scoped views (e.g., approvals), while sensitive amounts can remain private.
              </p>
            </details>
          </div>
        </section>
