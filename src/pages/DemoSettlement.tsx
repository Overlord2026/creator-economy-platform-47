...
export default function DemoSettlement() {
  const fakeReceiptId = 'RCPT-' + Math.random().toString(36).slice(2, 10).toUpperCase();
  return (
    <div style={{ maxWidth: 720, margin: '2rem auto', padding: 16 }}>
      <h1 style={{ marginBottom: 8 }}>Settlement — Demo</h1>
      <p style={{ color: '#555', marginBottom: 16 }}>Funds released. Receipt anchored (demo): <strong>{fakeReceiptId}</strong></p>
